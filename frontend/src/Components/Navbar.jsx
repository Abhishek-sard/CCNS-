        ...
        <ul className="hidden md:flex space-x-4 font-medium text-lg items-center">
          {isBlogPage ? (
            ...
            <>
              ...
              <AnimatedItem show={true}>
                <NavLink to="/job" className={linkClasses}>
                  Job Seeker
                </NavLink>
              </AnimatedItem>
              <AnimatedItem show={true}>
            ...
            <>
              ...
              <AnimatedItem show={true}>
                <NavLink to="/NdisContact" className={linkClasses}>
                  Referral
                </NavLink>
              </AnimatedItem>
            </>
        ...
        <div className="md:hidden bg-white shadow-lg border-t border-gray-200 px-6 py-6 space-y-3 font-medium">
          ...
          {isBlogPage ? (
            <>
              ...
              <NavLink to="/Staffing" className="block py-3 px-4 rounded-lg bg-teal-50">
                Staffing
              </NavLink>
              <NavLink to="/about" className="block py-3 px-4 rounded-lg bg-teal-50">
                About
              </NavLink>
              <NavLink to="/blog" className="block py-3 px-4 rounded-lg bg-teal-50">
                Blog
              </NavLink>
            </>
          ) : isStaffingPage ? (
            <>
              ...
              <NavLink
                to="/currentvaccancy"
                className="block py-3 px-4 rounded-lg bg-teal-50"
              >
                Current Vacancy
              </NavLink>
              <NavLink to="/about" className="block py-3 px-4 rounded-lg bg-teal-50">
            ...
            <>
              <NavLink to="/" className="block py-3 px-4 rounded-lg bg-teal-50">
                Home
              </NavLink>
              <NavLink to="/about" className="block py-3 px-4 rounded-lg bg-teal-50">
                About
